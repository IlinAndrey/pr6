...
public class TestSort {
    ...
    public static Student getStudent() {
        ...
        return new Student(random.nextInt(500), random.nextInt(100) % 5, random.nextInt(100) % 5, random.nextInt(100) % 5, "name " + (a++), "group " + (a % 4));
    }
    public static void main(String[] args) {

        System.out.println(" Sort for IDNumber:");
        ...
        System.out.println("Sort for SortingStudentsByGPA:");
